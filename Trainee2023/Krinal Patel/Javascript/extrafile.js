...
// }        
            ...
            console.log(cart)
                    ...
                    $('mytable').append(`<tr>
                    <td class="Book_Title">${cart.id}</td>
                    <td class="Author">${cart.name}</td>
                    <td class="Author">${cart.mobile}</td>
                    <td class="Author">${cart.email}</td>
                    <td class="Author">${cart.cname}</td>
                    <td class="Author">${cart.cgpa}</td>
                    <td class="Author">${cart.bname}</td>
                    <td class="Author">${cart.state}</td>
                    <td class="Author">${cart.city}</td>
                    <td class="Author">${cart.zip}</td>
                    <td class="Author">${cart.studied}</td>
                    <td class="Author">${cart.color}</td>
                    </tr>`) 
                })
