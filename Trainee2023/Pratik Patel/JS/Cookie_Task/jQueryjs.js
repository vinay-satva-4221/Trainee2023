...
$(document).ready(function () {
  ...
  function Statee(State) {
    ...
    } else if (State == 2) State = "Rajasthan";
    else if (State == 3) State = "Gujarat";
    else State = "Punjab";
    return State;
  }
  function cityy(City) {
    if (City == 1) {
      City = "Indore";
    } else if (City == 2) City = "Bhopal";
    else if (City == 3) City = "Sirohi";
    else if (City == 4) City = "Udaipur";
    else if (City == 5) City = "Jaisalmer";
    else if (City == 6) City = "Ahemdabad";
    else if (City == 7) City = "Vadodara";
    else if (City == 8) City = "Surat";
    else if (City == 9) City = "Ludhiana";
    else if (City == 10) City = "Amritsar";
    else City = "Patiala";
    return City;
  }
  function addlocalstorage() {
    ...
    var StudentDetails = JSON.parse(localStorage.getItem("users"))
  ...
  function doShowAll() {
    ...
    var list =
      "<tr><th>SR.No</th><th>Name</th><th>Mobile</th><th>Email</th><th>College Name</th><th>CGPA</th><th>Branch Name</th><th>study period</th><th>State</th><th>City</th><th>zip</th><th>Color</th><th></th><th></th> </tr>\n";
    // var i = 0;
    if (student_data) {
      for (let i = 0; i < student_data.length; i++) {
        ...
        list +=
          ...
          "</td><td>" +
          student_data[i].fromtowhenyoustudied +
          "</td><td>" +
          ...
          [i + 1] +
          " class='edit btn btn-success'>Edit</button><td> <button type='button' data-val=" +
          [i + 1] +
          " data-val='1' class='delete btn btn-danger'>Delete</button></td></tr>\n";
      }
    }
    $("#table").html(list);
    backgroundColor();
