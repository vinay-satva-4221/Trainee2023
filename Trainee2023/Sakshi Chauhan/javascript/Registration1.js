...
function showTab(n) {
  ...
  if(currentTab==4)
  {
    ...
    document.getElementById('last_name').innerHTML=document.getElementById('lname').value;
    document.getElementById('gender_table').innerHTML=document.getElementById('gender').value;
    document.getElementById('zipcode_table').innerHTML=document.getElementById('zipcode').value;
    document.getElementById('email_table').innerHTML=document.getElementById('email').value;
    document.getElementById('username_table').innerHTML=document.getElementById('uname').value;
    document.getElementById('password_table').innerHTML=document.getElementById('password').value;
    document.getElementById('bankname_table').innerHTML=document.getElementById('bank').value;
    document.getElementById('branchname_table').innerHTML=document.getElementById('branch').value;
    document.getElementById('accountname_table').innerHTML=document.getElementById('account').value;
    document.getElementById('accountnumber_table').innerHTML=document.getElementById('accountnumber').value;
    document.getElementById('card_table').innerHTML=document.getElementById('card').value;
    document.getElementById('holdername_table').innerHTML=document.getElementById('holdername').value;
    document.getElementById('cardnumber_table').innerHTML=document.getElementById('accountnumber').value;
    document.getElementById('cvv_table').innerHTML=document.getElementById('cvv').value;
    document.getElementById('expirydate_table').innerHTML=document.getElementById('exdate').value;
  }
...
function validatelastname()
{
    ...
    if(!regName.test(name)){
        vname.innerHTML=('Please enter your Last Name');
...
{
    var regName =  /^[A-Za-z][A-Za-z0-9_]{7,29}$/;
