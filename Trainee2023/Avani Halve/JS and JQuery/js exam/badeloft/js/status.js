...
$(document).ready(function () {
   ...
   var table = $("#example").DataTable({
      ...
      data: data,
      columns: [
         { data: "qb_invoice", className: "dt-control", orderable: false },
         { data: "name", orderable: false },
         { data: "qb_shipdate", orderable: false },
         { data: "qb_pay_status", orderable: false },
         { data: "status", orderable: false },
         { data: "qb_delievery_phone", orderable: false },
         { data: "called", orderable: false },
         { data: "qb_tracking", orderable: false },
      ],
      order: [[1, "asc"]],
   });
